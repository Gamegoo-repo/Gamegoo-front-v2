...
export const CHAT_DIALOG_TABS = ['friend-list', 'chatroom-list', 'chatroom'] as const;
...
export const useChatDialogStore = create<ChatDialogState>((set) => ({
  ...
  setChatDialogType: (chatDialogType: ChatDialogType) => set({ chatDialogType }),
  ...
  closeMannerModal: () => set({ isMannerModalOpen: false, mannerModalType: undefined }),
}));
