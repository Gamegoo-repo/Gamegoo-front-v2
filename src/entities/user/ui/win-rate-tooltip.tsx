...
export default function WinRateTooltip() {
  const content = (
    <div className="flex w-[255px] flex-col gap-3">
      <span className="semibold-18">현 시즌 성적 통계</span>
      <p className="regular-14 flex-wrap break-words">
  ...
  return (
    <Tooltip arrowPosition="right" content={content}>
      <button type="button" className="flex shrink-0 cursor-pointer items-center justify-center">
        <InfoIcon />
      </button>
    </Tooltip>
  );
