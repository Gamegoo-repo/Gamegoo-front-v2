...
export const useFetchPostsWithCursorQuery = ({
  ...
  const { data, isLoading, isFetching, isError, fetchNextPage, isFetchingNextPage, hasNextPage } =
    useInfiniteQuery({
      queryKey: boardKeys.infiniteList(params),
      queryFn: ({ pageParam }) => fetchPostsWithCursor(isAuthenticated, params, pageParam),
