...
export function PopoverProvider({
  ...
  const measureAndCompute = () => {
    if (triggerRef.current && contentRef.current) {
      ...
      const boundaryWidth = baseRect ? baseRect.right - baseRect.left : window.innerWidth;
      ...
      const boundaryHeight = baseRect ? baseRect.bottom - baseRect.top : window.innerHeight;
      if (y + contentRect.height > boundaryHeight - padding) {
        const triggerTopRelative = baseRect ? triggerRect.top - baseRect.top : triggerRect.top;
...
export function Popover({ children, containerRef, align = 'center' }: PopoverProps) {
  return (
