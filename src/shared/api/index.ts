...
export const api = {
  private: {
    auth: new AuthControllerApi(privateApiConfiguration, undefined, privateApiClient),
    ...
    notification: new NotificationApi(privateApiConfiguration, undefined, privateApiClient),
