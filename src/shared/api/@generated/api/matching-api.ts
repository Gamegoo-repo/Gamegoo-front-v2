...
export const MatchingApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    initializeMatching: async (
      ...
      const localVarPath = `/api/v2/internal/matching/priority/{memberId}`.replace(
        `{${'memberId'}}`,
     ...
     * @throws {RequiredError}
     */
    updateBothMatchingStatus: async (
      matchingUuid: string,
...
export const MatchingApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async findMatching(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseMatchingFoundResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.findMatching(
        matchingUuid,
        targetMatchingUuid,
        options
      );
      ...
      const localVarOperationServerBasePath =
        operationServerMap['MatchingApi.findMatching']?.[localVarOperationServerIndex]?.url;
    ...
    async initializeMatching(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponsePriorityListResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.initializeMatching(
        memberId,
        initializingMatchingRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MatchingApi.initializeMatching']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async successMatching(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.successMatching(
        matchingUuid,
        targetMatchingUuid,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MatchingApi.successMatching']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async updateBothMatchingStatus(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateBothMatchingStatus(
        matchingUuid,
        status,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MatchingApi.updateBothMatchingStatus']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async updateMatchingStatus(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateMatchingStatus(
        matchingUuid,
        status,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MatchingApi.updateMatchingStatus']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const MatchingApiFactory = function (
  ...
  return {
    ...
    findMatching(
      ...
      targetMatchingUuid: string,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseMatchingFoundResponse> {
      return localVarFp
        .findMatching(matchingUuid, targetMatchingUuid, options)
    ...
    initializeMatching(
      ...
      initializingMatchingRequest: InitializingMatchingRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponsePriorityListResponse> {
      return localVarFp
        .initializeMatching(memberId, initializingMatchingRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * API triggered when a match is succeed
    ...
    successMatching(
      ...
      return localVarFp
        .successMatching(matchingUuid, targetMatchingUuid, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * API for updating both matching status
    ...
    updateBothMatchingStatus(
      ...
      return localVarFp
        .updateBothMatchingStatus(matchingUuid, status, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * API for updating my matching status
    ...
    updateMatchingStatus(
      ...
      return localVarFp
        .updateMatchingStatus(matchingUuid, status, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class MatchingApi extends BaseAPI {
   ...
   * @memberof MatchingApi
   */
  public updateBothMatchingStatus(
    matchingUuid: string,
    status: MatchingStatus,
    options?: RawAxiosRequestConfig
  ) {
