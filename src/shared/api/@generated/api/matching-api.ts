 ...
 * @export
 */
export const MatchingApiAxiosParamCreator = function (
	...
	return {
		...
		findMatching: async (
			...
			const localVarPath =
				`/api/v2/internal/matching/found/{matchingUuid}/{targetMatchingUuid}`
					.replace(
						`{${"matchingUuid"}}`,
						encodeURIComponent(String(matchingUuid)),
					)
					.replace(
						`{${"targetMatchingUuid"}}`,
						encodeURIComponent(String(targetMatchingUuid)),
					);
		...
		initializeMatching: async (
			...
			const localVarPath =
				`/api/v2/internal/matching/priority/{memberId}`.replace(
					`{${"memberId"}}`,
	...
	return {
		...
		> {
			...
			const localVarOperationServerBasePath =
				operationServerMap["MatchingApi.findMatching"]?.[
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.initializeMatching(
					memberId,
					initializingMatchingRequest,
					options,
				);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["MatchingApi.initializeMatching"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["MatchingApi.successMatching"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.updateBothMatchingStatus(
					matchingUuid,
					status,
					options,
				);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["MatchingApi.updateBothMatchingStatus"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.updateMatchingStatus(
					matchingUuid,
					status,
					options,
				);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["MatchingApi.updateMatchingStatus"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
