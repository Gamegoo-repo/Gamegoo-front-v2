...
export const FriendApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async acceptFriendRequest(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseFriendRequestResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.acceptFriendRequest(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['FriendApi.acceptFriendRequest']?.[localVarOperationServerIndex]?.url;
    ...
    async cancelFriendRequest(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseFriendRequestResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.cancelFriendRequest(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['FriendApi.cancelFriendRequest']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async deleteFriend(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseDeleteFriendResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteFriend(memberId, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['FriendApi.deleteFriend']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getFriendList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseFriendListResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getFriendList(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['FriendApi.getFriendList']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async rejectFriendRequest(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseFriendRequestResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.rejectFriendRequest(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['FriendApi.rejectFriendRequest']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async reverseFriendLiked(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseStarFriendResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.reverseFriendLiked(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['FriendApi.reverseFriendLiked']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async searchFriend(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseListFriendInfoResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.searchFriend(query, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['FriendApi.searchFriend']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async sendFriendRequest(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseFriendRequestResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.sendFriendRequest(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['FriendApi.sendFriendRequest']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
