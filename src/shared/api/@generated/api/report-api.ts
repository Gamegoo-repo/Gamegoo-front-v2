...
export const ReportApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async addReport(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseReportInsertResponse>
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['ReportApi.addReport']?.[localVarOperationServerIndex]?.url;
    ...
    async deleteReportedPost(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteReportedPost(
        reportId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ReportApi.deleteReportedPost']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getReportList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseReportPageResponse>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ReportApi.getReportList']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async processReport(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseReportProcessResponse>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ReportApi.processReport']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
