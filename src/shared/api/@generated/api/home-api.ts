...
export const HomeApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getTestAccessToken: async (
      memberId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'memberId' is not null or undefined
      assertParamExists('getTestAccessToken', 'memberId', memberId);
      const localVarPath = `/home/tokens/{memberId}`.replace(
        `{${'memberId'}}`,
    ...
    refreshStats: async (
      ...
      const localVarPath = `/home/refresh/stats/{memberId}`.replace(
        `{${'memberId'}}`,
        encodeURIComponent(String(memberId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    async error(
      ...
      const localVarOperationServerBasePath =
        operationServerMap['HomeApi.error']?.[localVarOperationServerIndex]?.url;
    ...
    async getMemberId(
      riotUserInfo: RiotUserInfo,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseLong>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMemberId(riotUserInfo, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['HomeApi.getMemberId']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getTestAccessToken(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseTokensResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getTestAccessToken(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['HomeApi.getTestAccessToken']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async healthcheck(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['HomeApi.healthcheck']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async joinTest(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['HomeApi.joinTest']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async refreshStats(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['HomeApi.refreshStats']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const HomeApiFactory = function (
  ...
  return {
    ...
    getMemberId(
      ...
      return localVarFp
        .getMemberId(riotUserInfo, options)
    ...
    getTestAccessToken(
      memberId: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseTokensResponse> {
      return localVarFp
        .getTestAccessToken(memberId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * health check를 위한 API 입니다.
