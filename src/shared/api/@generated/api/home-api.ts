...
export const HomeApiAxiosParamCreator = function (
	...
	return {
		...
		getTestAccessToken: async (
			...
			const localVarPath = `/home/token/{memberId}`.replace(
				`{${"memberId"}}`,
	...
	return {
		...
		> {
			...
			const localVarOperationServerBasePath =
				operationServerMap["HomeApi.error"]?.[localVarOperationServerIndex]
					?.url;
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getMemberId(
				riotUserInfo,
				options,
			);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["HomeApi.getMemberId"]?.[
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getTestAccessToken(memberId, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["HomeApi.getTestAccessToken"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["HomeApi.healthcheck"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.joinTest(
				riotUserInfo,
				options,
			);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["HomeApi.joinTest"]?.[localVarOperationServerIndex]
					?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.refreshStats(
				memberId,
				options,
			);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["HomeApi.refreshStats"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
