...
export const PasswordControllerApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async checkPassword(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponsePasswordCheckResponse>
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['PasswordControllerApi.checkPassword']?.[localVarOperationServerIndex]
          ?.url;
    ...
    async resetPassword(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PasswordControllerApi.resetPassword']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async resetPasswordWithJWT(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.resetPasswordWithJWT(
        passwordResetRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PasswordControllerApi.resetPasswordWithJWT']?.[
 ...
 * @export
 */
export const PasswordControllerApiFactory = function (
  ...
  return {
    ...
    checkPassword(
      passwordCheckRequest: PasswordCheckRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponsePasswordCheckResponse> {
      return localVarFp
    ...
    resetPassword(
      ...
      return localVarFp
        .resetPassword(passwordResetWithVerifyRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * API for reseting password JWT O
    ...
    resetPasswordWithJWT(
      ...
      return localVarFp
        .resetPasswordWithJWT(passwordResetRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class PasswordControllerApi extends BaseAPI {
  ...
  public checkPassword(
    ...
    return PasswordControllerApiFp(this.configuration)
      .checkPassword(passwordCheckRequest, options)
