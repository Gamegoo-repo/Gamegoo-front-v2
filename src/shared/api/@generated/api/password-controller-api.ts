 ...
 * @export
 */
export const PasswordControllerApiAxiosParamCreator = function (
 ...
 * @export
 */
export const PasswordControllerApiFp = function (
	configuration?: Configuration,
) {
	const localVarAxiosParamCreator =
		PasswordControllerApiAxiosParamCreator(configuration);
	return {
		/**
		 * API for checking password
		 * @summary 비밀번호 확인 API 입니다.
		...
		> {
			...
			const localVarOperationServerBasePath =
				operationServerMap["PasswordControllerApi.checkPassword"]?.[
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PasswordControllerApi.resetPassword"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.resetPasswordWithJWT(
					passwordResetRequest,
					options,
				);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
