	...
	return {
		...
		> {
			...
			const localVarOperationServerBasePath =
				operationServerMap["EmailApi.sendEmail"]?.[localVarOperationServerIndex]
					?.url;
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.sendEmailWithCheckDuplication(
					emailRequest,
					options,
				);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["EmailApi.sendEmailWithCheckDuplication"]?.[
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["EmailApi.verifyEmail"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
