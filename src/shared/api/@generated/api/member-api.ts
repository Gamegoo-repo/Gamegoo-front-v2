  ...
  return {
    ...
    async addGameStyle(
      ...
      const localVarOperationServerBasePath =
        operationServerMap['MemberApi.addGameStyle']?.[localVarOperationServerIndex]?.url;
    ...
    async getMember(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseOtherProfileResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMember(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MemberApi.getMember']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getMemberJWT(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseMyProfileResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMemberJWT(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MemberApi.getMemberJWT']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async grantAdminRole(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MemberApi.grantAdminRole']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async modifyIsMike(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MemberApi.modifyIsMike']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async modifyPosition(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MemberApi.modifyPosition']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async modifyProfileImage(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.modifyProfileImage(
        profileImageRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MemberApi.modifyProfileImage']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async refreshChampionStats(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseMyProfileResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.refreshChampionStats(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MemberApi.refreshChampionStats']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async revokeAdminRole(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['MemberApi.revokeAdminRole']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
