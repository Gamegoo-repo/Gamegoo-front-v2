...
export const ChatInternalApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getChatroomUuid: async (
      memberId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'memberId' is not null or undefined
      assertParamExists('getChatroomUuid', 'memberId', memberId);
      const localVarPath = `/api/v2/internal/{memberId}/chatroom/uuid`.replace(
        `{${'memberId'}}`,
...
export const ChatInternalApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async addChat(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseChatCreateResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addChat(
        memberId,
        chatroomUuid,
        chatCreateRequest,
        options
      ...
      const localVarOperationServerBasePath =
        operationServerMap['ChatInternalApi.addChat']?.[localVarOperationServerIndex]?.url;
    ...
    async getChatroomUuid(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ChatInternalApi.getChatroomUuid']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const ChatInternalApiFactory = function (
  ...
  return {
    ...
    addChat(
      ...
      chatCreateRequest: ChatCreateRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseChatCreateResponse> {
      return localVarFp
        .addChat(memberId, chatroomUuid, chatCreateRequest, options)
    ...
    getChatroomUuid(
      ...
      return localVarFp
        .getChatroomUuid(memberId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ChatInternalApi extends BaseAPI {
  ...
  public addChat(
    ...
    return ChatInternalApiFp(this.configuration)
      .addChat(memberId, chatroomUuid, chatCreateRequest, options)
