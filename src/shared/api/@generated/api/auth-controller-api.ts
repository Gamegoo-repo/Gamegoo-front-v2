  ...
  return {
    ...
    async blindMember(
      ...
      const localVarOperationServerBasePath =
        operationServerMap['AuthControllerApi.blindMember']?.[localVarOperationServerIndex]?.url;
    ...
    async getTestAccessToken1(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getTestAccessToken1(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthControllerApi.getTestAccessToken1']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async logout(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthControllerApi.logout']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async rejoinMember(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseRejoinResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.rejoinMember(
        rejoinRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthControllerApi.rejoinMember']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async updateToken(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseRefreshTokenResponse>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthControllerApi.updateToken']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const AuthControllerApiFactory = function (
  ...
  return {
    ...
    rejoinMember(
      rejoinRequest: RejoinRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseRejoinResponse> {
      return localVarFp
        .rejoinMember(rejoinRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * API for Refresh Token
