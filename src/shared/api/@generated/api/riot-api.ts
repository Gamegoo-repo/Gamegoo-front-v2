...
export const RiotApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async handleRSOCallback(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.handleRSOCallback(
        code,
        state,
        options
      );
      ...
      const localVarOperationServerBasePath =
        operationServerMap['RiotApi.handleRSOCallback']?.[localVarOperationServerIndex]?.url;
    ...
    async joinByRSO(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseRiotJoinResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.joinByRSO(riotJoinRequest, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['RiotApi.joinByRSO']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async verifyRiot(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.verifyRiot(
        riotVerifyExistUserRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['RiotApi.verifyRiot']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const RiotApiFactory = function (
  ...
  return {
    ...
    handleRSOCallback(
      ...
      return localVarFp
        .handleRSOCallback(code, state, options)
    ...
    joinByRSO(
      riotJoinRequest: RiotJoinRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseRiotJoinResponse> {
      return localVarFp
        .joinByRSO(riotJoinRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * API for verifying account by riot API
    ...
    verifyRiot(
      ...
      return localVarFp
        .verifyRiot(riotVerifyExistUserRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class RiotApi extends BaseAPI {
  ...
  public handleRSOCallback(code: string, state?: string, options?: RawAxiosRequestConfig) {
    return RiotApiFp(this.configuration)
      .handleRSOCallback(code, state, options)
