 ...
 * @export
 */
export const RiotApiAxiosParamCreator = function (
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.handleRSOCallback(code, state, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["RiotApi.handleRSOCallback"]?.[
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.joinByRSO(
				riotJoinRequest,
				options,
			);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["RiotApi.joinByRSO"]?.[localVarOperationServerIndex]
					?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["RiotApi.verifyRiot"]?.[localVarOperationServerIndex]
					?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
