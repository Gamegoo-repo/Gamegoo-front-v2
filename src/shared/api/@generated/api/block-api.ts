...
export const BlockApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    blockMember: async (
      ...
      const localVarPath = `/api/v2/block/{memberId}`.replace(
        `{${'memberId'}}`,
     ...
     * @throws {RequiredError}
     */
    deleteBlockMember: async (
      memberId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'memberId' is not null or undefined
      assertParamExists('deleteBlockMember', 'memberId', memberId);
      const localVarPath = `/api/v2/block/delete/{memberId}`.replace(
        `{${'memberId'}}`,
        encodeURIComponent(String(memberId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const BlockApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async blockMember(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBlockResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.blockMember(memberId, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BlockApi.blockMember']?.[localVarOperationServerIndex]?.url;
    ...
    async deleteBlockMember(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBlockResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteBlockMember(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BlockApi.deleteBlockMember']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getBlockList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBlockListResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getBlockList(page, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BlockApi.getBlockList']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BlockApi.unblockMember']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const BlockApiFactory = function (
  ...
  return {
    ...
    blockMember(
      memberId: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseBlockResponse> {
    ...
    deleteBlockMember(
      ...
      return localVarFp
        .deleteBlockMember(memberId, options)
    ...
    getBlockList(
      page: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseBlockListResponse> {
    ...
    unblockMember(
      ...
      return localVarFp
        .unblockMember(memberId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class BlockApi extends BaseAPI {
  ...
  public blockMember(memberId: number, options?: RawAxiosRequestConfig) {
    return BlockApiFp(this.configuration)
      .blockMember(memberId, options)
