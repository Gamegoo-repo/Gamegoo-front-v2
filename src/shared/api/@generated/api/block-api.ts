 ...
 * @export
 */
export const BlockApiAxiosParamCreator = function (
...
export const BlockApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.blockMember(
				memberId,
				options,
			);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["BlockApi.blockMember"]?.[
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.deleteBlockMember(memberId, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["BlockApi.deleteBlockMember"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getBlockList(
				page,
				options,
			);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["BlockApi.getBlockList"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.unblockMember(
				memberId,
				options,
			);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["BlockApi.unblockMember"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
