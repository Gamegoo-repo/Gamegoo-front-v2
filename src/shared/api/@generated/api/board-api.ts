...
export const BoardApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    _delete: async (boardId: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v2/posts/{boardId}`.replace(
        `{${'boardId'}}`,
    ...
    bumpBoard: async (
      ...
      const localVarPath = `/api/v2/posts/{boardId}/bump`.replace(
        `{${'boardId'}}`,
        encodeURIComponent(String(boardId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    deleteGuestBoard: async (
      ...
      const localVarPath = `/api/v2/posts/guest/{boardId}`.replace(
        `{${'boardId'}}`,
        encodeURIComponent(String(boardId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getBoardById: async (
      ...
      const localVarPath = `/api/v2/posts/list/{boardId}`.replace(
        `{${'boardId'}}`,
        encodeURIComponent(String(boardId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getBoardByIdForMember: async (
      boardId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'boardId' is not null or undefined
      assertParamExists('getBoardByIdForMember', 'boardId', boardId);
      const localVarPath = `/api/v2/posts/member/list/{boardId}`.replace(
        `{${'boardId'}}`,
        encodeURIComponent(String(boardId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getBoardsWithCursor: async (
      ...
      if (cursor !== undefined) {
        localVarQueryParameter['cursor'] =
          (cursor as any) instanceof Date ? (cursor as any).toISOString() : cursor;
      }
...
export const BoardApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async _delete(
      boardId: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseString>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator._delete(boardId, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi._delete']?.[localVarOperationServerIndex]?.url;
    ...
    async boardInsert(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBoardInsertResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.boardInsert(
        boardInsertRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.boardInsert']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async boardList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBoardResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.boardList(
        page,
        gameMode,
        tier,
        mainP,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.boardList']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async boardUpdate(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBoardUpdateResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.boardUpdate(
        boardId,
        boardUpdateRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.boardUpdate']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async bumpBoard(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBoardBumpResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.bumpBoard(boardId, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.bumpBoard']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.bumpLatestBoard']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async deleteGuestBoard(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteGuestBoard(
        boardId,
        guestBoardDeleteRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.deleteGuestBoard']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getBoardById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBoardByIdResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getBoardById(boardId, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.getBoardById']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getBoardByIdForMember(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ApiResponseBoardByIdResponseForMember>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getBoardByIdForMember(
        boardId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.getBoardByIdForMember']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getBoardsWithCursor(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBoardCursorResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getBoardsWithCursor(
        cursor,
        cursorId,
        gameMode,
        tier,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.getBoardsWithCursor']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getMyBoardCursorList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseMyBoardCursorResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMyBoardCursorList(
        cursor,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.getMyBoardCursorList']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getMyBoardList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseMyBoardResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMyBoardList(page, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.getMyBoardList']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async guestBoardInsert(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBoardInsertResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.guestBoardInsert(
        guestBoardInsertRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.guestBoardInsert']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async guestBoardUpdate(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseBoardUpdateResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.guestBoardUpdate(
        boardId,
        guestBoardUpdateRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BoardApi.guestBoardUpdate']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const BoardApiFactory = function (
  ...
  return {
    ...
    boardInsert(
      boardInsertRequest: BoardInsertRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseBoardInsertResponse> {
      return localVarFp
        .boardInsert(boardInsertRequest, options)
    ...
    boardList(
      ...
      mike?: Mike,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseBoardResponse> {
      return localVarFp
        .boardList(page, gameMode, tier, mainP, subP, mike, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 게시판에서 글을 수정하는 API 입니다.
    ...
    boardUpdate(
      ...
      boardUpdateRequest: BoardUpdateRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseBoardUpdateResponse> {
      return localVarFp
        .boardUpdate(boardId, boardUpdateRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 게시글을 끌올하여 상단 노출시키는 API 입니다. 마지막 끌올 후 5분 제한이 적용됩니다.
    ...
    bumpBoard(
      boardId: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseBoardBumpResponse> {
    ...
    deleteGuestBoard(
      ...
      return localVarFp
        .deleteGuestBoard(boardId, guestBoardDeleteRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 게시판에서 글을 조회하는 API 입니다.
    ...
    getBoardById(
      boardId: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseBoardByIdResponse> {
    ...
    getBoardByIdForMember(
      ...
      return localVarFp
        .getBoardByIdForMember(boardId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 커서 기반(무한 스크롤)으로 게시판 글 목록을 조회하는 API 입니다. 최신 글부터 순차적으로 내려가며, 커서와 cursorId를 이용해 다음 페이지를 조회할 수 있습니다. 필터링을 원하면 각 파라미터를 입력하세요.
    ...
    getBoardsWithCursor(
      ...
      mike?: Mike,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseBoardCursorResponse> {
      return localVarFp
        .getBoardsWithCursor(cursor, cursorId, gameMode, tier, position1, position2, mike, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 모바일에서 내가 작성한 게시판 글을 조회하는 API 입니다.
    ...
    getMyBoardCursorList(
      cursor?: string,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseMyBoardCursorResponse> {
      return localVarFp
        .getMyBoardCursorList(cursor, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 내가 작성한 게시판 글을 조회하는 API 입니다. 페이지 당 10개의 게시물이 표시됩니다.
    ...
    getMyBoardList(
      page: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiResponseMyBoardResponse> {
    ...
    guestBoardInsert(
      ...
      return localVarFp
        .guestBoardInsert(guestBoardInsertRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 비회원이 게시판에서 글을 수정하는 API 입니다.
    ...
    guestBoardUpdate(
      ...
      return localVarFp
        .guestBoardUpdate(boardId, guestBoardUpdateRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
