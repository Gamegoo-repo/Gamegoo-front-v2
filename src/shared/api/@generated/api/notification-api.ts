...
export const NotificationApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    readMultipleNotifications: async (
      notificationMultiRequest: NotificationMultiRequest,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'notificationMultiRequest' is not null or undefined
...
export const NotificationApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async deleteMultipleNotifications(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteMultipleNotifications(
        notificationMultiRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['NotificationApi.deleteMultipleNotifications']?.[
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getNotificationListByCursor(
        cursor,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getNotificationListByPage(
        page,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    async getUnreadNotificationCount(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseInteger>> {
     ...
     * @throws {RequiredError}
     */
    async readMultipleNotifications(
      notificationMultiRequest: NotificationMultiRequest,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseString>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.readMultipleNotifications(
        notificationMultiRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['NotificationApi.readMultipleNotifications']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.readNotification(
        notificationId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['NotificationApi.readNotification']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const NotificationApiFactory = function (
  ...
  return {
    ...
    deleteMultipleNotifications(
      ...
      return localVarFp
        .deleteMultipleNotifications(notificationMultiRequest, options)
    ...
    readMultipleNotifications(
      ...
      return localVarFp
        .readMultipleNotifications(notificationMultiRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 특정 알림을 읽음 처리하는 API 입니다.
...
export class NotificationApi extends BaseAPI {
   ...
   */
  public deleteMultipleNotifications(
    notificationMultiRequest: NotificationMultiRequest,
    options?: RawAxiosRequestConfig
  ) {
   ...
   * @memberof NotificationApi
   */
  public readMultipleNotifications(
    notificationMultiRequest: NotificationMultiRequest,
    options?: RawAxiosRequestConfig
  ) {
    return NotificationApiFp(this.configuration)
