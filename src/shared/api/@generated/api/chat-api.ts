...
export const ChatApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async enterChatroom(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseEnterChatroomResponse>
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['ChatApi.enterChatroom']?.[localVarOperationServerIndex]?.url;
    ...
    async exitChatroom(
      chatroomUuid: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseObject>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.exitChatroom(chatroomUuid, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ChatApi.exitChatroom']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getChatMessages(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseChatMessageListResponse>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ChatApi.getChatMessages']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getChatroom(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseChatroomListResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getChatroom(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ChatApi.getChatroom']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getUnreadChatroomUuid(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseListString>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getUnreadChatroomUuid(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ChatApi.getUnreadChatroomUuid']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async readChatMessage(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ChatApi.readChatMessage']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async startChatroomByBoardId(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseEnterChatroomResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.startChatroomByBoardId(
        boardId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ChatApi.startChatroomByBoardId']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async startChatroomByMemberId(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseEnterChatroomResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.startChatroomByMemberId(
        memberId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ChatApi.startChatroomByMemberId']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
