...
```typescript
import { ReportApi, Configuration, ReportRequest } from './api';
...
const { status, data } = await apiInstance.addReport(memberId, reportRequest);
```
...
```typescript
import { ReportApi, Configuration } from './api';
...
const { status, data } = await apiInstance.deleteReportedPost(reportId);
```
...
```typescript
import { ReportApi, Configuration, Pageable } from './api';
...
```typescript
import { ReportApi, Configuration, ReportProcessRequest } from './api';
...
const { status, data } = await apiInstance.processReport(reportId, reportProcessRequest);
```
