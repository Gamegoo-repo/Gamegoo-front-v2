...
```typescript
import { BoardApi, Configuration } from './api';
...
const { status, data } = await apiInstance._delete(boardId);
```
...
```typescript
import { BoardApi, Configuration, BoardInsertRequest } from './api';
...
const { status, data } = await apiInstance.boardInsert(boardInsertRequest);
```
...
const { status, data } = await apiInstance.boardList(page, gameMode, tier, mainP, subP, mike);
```
...
```typescript
import { BoardApi, Configuration, BoardUpdateRequest } from './api';
...
const { status, data } = await apiInstance.boardUpdate(boardId, boardUpdateRequest);
```
...
const { status, data } = await apiInstance.bumpBoard(boardId);
```
...
```typescript
import { BoardApi, Configuration, GuestBoardDeleteRequest } from './api';
...
const { status, data } = await apiInstance.deleteGuestBoard(boardId, guestBoardDeleteRequest);
```
...
const { status, data } = await apiInstance.getBoardById(boardId);
```
...
const { status, data } = await apiInstance.getBoardByIdForMember(boardId);
```
...
const { status, data } = await apiInstance.getMyBoardCursorList(cursor);
```
...
const { status, data } = await apiInstance.getMyBoardList(page);
```
...
```typescript
import { BoardApi, Configuration, GuestBoardInsertRequest } from './api';
...
const { status, data } = await apiInstance.guestBoardInsert(guestBoardInsertRequest);
```
...
```typescript
import { BoardApi, Configuration, GuestBoardUpdateRequest } from './api';
...
const { status, data } = await apiInstance.guestBoardUpdate(boardId, guestBoardUpdateRequest);
```
