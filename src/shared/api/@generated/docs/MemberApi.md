...
```typescript
import { MemberApi, Configuration, GameStyleRequest } from './api';
...
const { status, data } = await apiInstance.addGameStyle(gameStyleRequest);
```
...
```typescript
import { MemberApi, Configuration } from './api';
...
const { status, data } = await apiInstance.getMember(id);
```
...
const { status, data } = await apiInstance.grantAdminRole(memberId);
```
...
```typescript
import { MemberApi, Configuration, IsMikeRequest } from './api';
...
const { status, data } = await apiInstance.modifyIsMike(isMikeRequest);
```
...
```typescript
import { MemberApi, Configuration, PositionRequest } from './api';
...
const { status, data } = await apiInstance.modifyPosition(positionRequest);
```
...
```typescript
import { MemberApi, Configuration, ProfileImageRequest } from './api';
...
const { status, data } = await apiInstance.modifyProfileImage(profileImageRequest);
```
...
const { status, data } = await apiInstance.refreshChampionStats(memberId);
```
...
const { status, data } = await apiInstance.revokeAdminRole(memberId);
```
