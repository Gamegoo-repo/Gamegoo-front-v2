...
```typescript
import { FriendApi, Configuration } from './api';
...
const { status, data } = await apiInstance.acceptFriendRequest(memberId);
```
...
const { status, data } = await apiInstance.cancelFriendRequest(memberId);
```
...
const { status, data } = await apiInstance.deleteFriend(memberId);
```
...
const { status, data } = await apiInstance.rejectFriendRequest(memberId);
```
...
const { status, data } = await apiInstance.reverseFriendLiked(memberId);
```
...
const { status, data } = await apiInstance.searchFriend(query);
```
...
const { status, data } = await apiInstance.sendFriendRequest(memberId);
```
