...
```typescript
import { PasswordControllerApi, Configuration, PasswordCheckRequest } from './api';
...
const { status, data } = await apiInstance.checkPassword(passwordCheckRequest);
```
...
```typescript
import { PasswordControllerApi, Configuration, PasswordResetWithVerifyRequest } from './api';
...
const { status, data } = await apiInstance.resetPassword(passwordResetWithVerifyRequest);
```
...
```typescript
import { PasswordControllerApi, Configuration, PasswordResetRequest } from './api';
...
const { status, data } = await apiInstance.resetPasswordWithJWT(passwordResetRequest);
```
