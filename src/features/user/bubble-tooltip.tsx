...
export default function BubbleTooltip({
  ...
  return (
    ...
    >
      {/* 말풍선 본체 */}
      <div className="absolute bottom-[10px] left-1/2 -translate-x-1/2 rounded-[46px] border border-violet-400 bg-gray-100 px-[13px] py-[7px] whitespace-nowrap shadow-[0_4px_14px_rgba(90,66,238,0.14)]">
        <p className="text-[11px] font-medium text-gray-800">{message}</p>
      </div>
    </div>
  );
}
