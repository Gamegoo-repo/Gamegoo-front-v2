  ...
  return (
    ...
    >
      <div className="flex flex-col border-b border-gray-300">
        <button type="button" className="self-end p-3" onClick={onClose} aria-label="닫기">
        ...
        <div className="mb-4 flex h-[94px] items-center justify-evenly px-2 pt-[6px]">
          <button
            type="button"
            className={clsx(
              'flex cursor-pointer flex-col items-center justify-center select-none',
          ...
          >
            <SmileIcon width={32} height={32} />
            <p className="regular-18 mt-[11px] text-gray-800">비매너 평가하기</p>
          </button>
        </div>
      </div>
