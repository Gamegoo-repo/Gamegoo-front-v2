...
type Tier = Parameters<typeof TierBadge>[0] extends { tier: infer T } ? T : never;
type Rank = Parameters<typeof TierBadge>[0] extends { rank: infer R } ? R : never;
...
export default function ProfileSummaryCard({
  ...
  return (
    <div className={`flex w-full flex-col gap-6 rounded-2xl bg-violet-100 p-6 ${className || ''}`}>
      {/* Top: avatar + name */}
