  ...
  return (
    <div ref={containerRef} className="relative shrink-0">
      ...
      >
        ...
        <div className="absolute bottom-[2px] left-1/2 inline-flex h-[25px] w-[49px] -translate-x-1/2 cursor-pointer items-center justify-center rounded-[57px] bg-black/65 px-[10px] py-[6px] opacity-100">
          <span className="bold-12 leading-none text-violet-300">LV.{mannerLevel}</span>
        </div>
      </MannerLevelPopover>
    </div>
  );
