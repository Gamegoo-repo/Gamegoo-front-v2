...
export default function LolBtiLoadingSection() {
  return (
    <LolBtiLayout>
      <FlexBox direction="column" align="center" justify="center" className="h-full w-full">
        <h1 className="text-2xl font-bold text-white drop-shadow-[0_0_30px_rgba(255,255,255,0.3)]">
          결과를 불러오는 중...
        </h1>
