...
export default function LolBtiLandingSection({ onStart }: LolBtiQuizSectionProps) {
  ...
  return (
    <LolBtiLayout>
      <FlexBox direction="column" align="center" className="w-full flex-1 p-7">
        ...
        <FlexBox direction="column" align="center" asChild>
          <section className="mt-7">
            ...
            <p className="mt-4 text-[19px] text-[#CCC]">나의 롤 플레이 스타일을 알아보자!</p>
            <FlexBox
              align="center"
              justify="center"
            ...
            {
              <p className="mt-[52px] inline-block rounded-full border border-white/20 bg-white/10 px-6 py-2 text-[15px] text-[#9A9A9A]">
                지금까지{' '}
                <span className="inline-block text-center font-bold text-white tabular-nums">
            ...
            >
              <button
                type="button"
                className="w-[80%] max-w-[280px] cursor-pointer rounded-lg bg-[linear-gradient(80deg,var(--color-blue-60,#5A42EE)_0%,var(--color-blue-70,#7A66FF)_100%)] px-6 py-[14px] text-base leading-normal font-bold text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(90,66,238,0.5)]"
                onClick={onStart}
              >
                시작하기
              </button>
              ...
              <button
                type="button"
                className="cursor-pointer rounded-lg text-base leading-normal font-bold text-[#BFBFBF] transition-all duration-300 hover:underline hover:underline-offset-4"
            ...
            <article className="text-center text-[15px] text-[#9A9A9A]">
      ...
      <Link
        to="/"
        className="flex h-[60px] w-full items-center justify-center bg-[#7560FC] text-base font-bold text-white"
      >
        겜구에서 친구 찾기👉
      </Link>
    </LolBtiLayout>
