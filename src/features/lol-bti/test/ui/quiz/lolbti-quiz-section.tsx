...
export default function LolBtiQuizSection({
  ...
  return (
    <LolBtiLayout>
      <FlexBox direction="column" align="center" gap="xs" className="w-full p-7">
        <header className="relative flex w-full items-center justify-center p-1.5">
          <button
            type="button"
            onClick={onUndoAnswer}
            className="absolute top-1/2 left-4 flex -translate-y-1/2 cursor-pointer items-center justify-center"
          >
            <span className="chev-icon"></span>
          </button>
          <h3 className="text-base font-semibold text-[#888]">
        ...
        <FlexBox direction="column" gap="md" align="center" asChild>
          <section className="w-full pt-4 pb-8">
            ...
            <article className="min-h-[3.5rem] text-center text-xl font-semibold break-keep whitespace-pre-line text-white">
