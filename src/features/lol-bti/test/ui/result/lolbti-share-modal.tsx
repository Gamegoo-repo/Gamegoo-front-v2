        ...
        >
            ...
            >
                ...
                <div className='w-full flex items-center justify-center pt-4 pb-6'>
                    <img className='w-[170px]' src={`/assets/images/result-cards/${result}.png`} alt={`${result} 결과 카드`} />
                </div>

                <div className='w-full border-t-[1px] border-t-gray-700 py-4 flex items-center px-5 gap-4'>{children}</div>
            </div>
        </div>,
        document.body,
    );
