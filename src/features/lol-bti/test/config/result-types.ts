...
export const LOL_BTI_TYPE_DATA: Record<LolBtiResultType, LolBtiTypeData> = {
  ADCI: {
    title: '단독 캐리형',
    description: '공격적인 교전으로 성장하고, 혼자 한타를 열어 팀을 캐리하는 것을 선호하는 유형',
    imageIndex: 1,
    quote: '내가 캐리하면 다 끝.',
  ...
  ADCB: {
    title: '돌격형 딜러',
    description: '공격적인 교전을 통해 자신의 성장을 극대화하고, 후방에서 홀로 게임을 끝내는 유형',
    imageIndex: 2,
    quote: '딜만 넣으면 이긴다.',
  ...
  ADTI: {
    title: '교전 설계자',
    description: '자신의 성장을 우선시하지만, 팀을 위해 먼저 이니시를 열어 승리를 쟁취하는 유형',
    imageIndex: 3,
    quote: '성장해서 팀을 도와주겠다.',
  ...
  ADTB: {
    title: '폭발적 협동가',
    description: '공격적 플레이로 성장하며, 팀원과 함께 후방에서 집중적인 딜을 쏟아붓는 유형',
    imageIndex: 4,
  ...
  ASCI: {
    // 진행중
    title: '숨은 영웅',
    description: '팀에게 자원을 양보하면서도 적극적으로 싸우고, 한타를 캐리하려는 유형',
    imageIndex: 5,
    quote: '숨어서 팀을 캐리한다.',
  ...
  ASCB: {
    title: '전략적 설계자',
    description: '팀에 헌신하며 이득을 주고, 후방에서 결정적인 스킬로 캐리 각을 만드는 유형',
    imageIndex: 6,
  ...
  ASTB: {
    title: '전장의 조율자',
    description: '팀에게 자원을 양보하고 교전에 참여하며, 후방에서 팀 전체의 딜을 조율하는 유형',
    imageIndex: 8,
    quote: '팀의 딜을 조율한다.',
  ...
  FDTI: {
    ...
    strengths: '안정적인 성장과 강력한 이니시에이팅 능력을 갖춘 플레이어입니다.',
    weaknesses: '초반 팀 기여도가 낮을 수 있습니다.',
    positions: {
      top: [
