...
export default function LolBtiTestCtaCard() {
  return (
    <div className="flex w-full flex-col items-center rounded-[20px] bg-gray-900 p-4 pt-14 shadow-[0px_4px_20px_0_rgba(0,0,0,0.25)]">
      <h3 className="mb-12 text-4xl font-[900] text-white">내 롤BTI는?</h3>
      <FlexBox direction="column" align="center" className="w-full blur-sm">
        ...
        />
        <span className="mb-7 inline-block text-center text-xl font-bold text-white">겜구겜구</span>
        <FlexBox
          direction="row"
          align="center"
          justify="center"
        ...
        >
          {MOCK_USER_PROFILE.championStatsResponseList.map((champion) => (
            <div key={champion.championId} className="flex flex-col items-center justify-center">
              <img
