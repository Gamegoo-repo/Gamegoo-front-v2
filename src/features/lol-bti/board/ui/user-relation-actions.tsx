...
export default function UserRelationActions({ result }: UserRelationActionsProps) {
  const { mutate: sendFriendRequest, isPending } = useSendFriendRequest(result.memberId);
