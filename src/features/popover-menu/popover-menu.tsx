...
function PopoverMenu({ menuItems, align = 'end', contentClassName }: PopoverMenuProps) {
  return (
    <Popover align={align}>
...
function PopoverMenuContent({ menuItems }: PopoverMenuProps) {
  ...
  return (
    <div className="medium-14 text-gray-600 [&>*:not(:last-child)]:border-b [&>*:not(:last-child)]:border-gray-200">
