...
function FriendItem({
  ...
  const isOnline = friend.memberId ? onlineFriends.includes(friend.memberId) : false;
      ...
      <div className="ml-3 flex-1">
        <div className="flex items-center gap-2">
          <div className="relative flex flex-col gap-[2px]">
            ...
            {isOnline && (
              <div className="absolute -top-1 -right-4 h-[10px] w-[10px] rounded-full border-2 border-white bg-green-500" />
            )}
          </div>
        </div>
      </div>
