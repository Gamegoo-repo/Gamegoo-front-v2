...
import type { AdjustPositionCallback, DragOffset, Position } from '../model/types';
...
export const useDrag = ({
  ...
  const handleDragStart = (e: React.MouseEvent<HTMLElement>) => {
    ...
    const draggableElement = e.currentTarget.closest('[data-draggable-container]') as HTMLElement;
