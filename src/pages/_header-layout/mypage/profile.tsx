...
function RouteComponent() {
  ...
  const [selectedGameStyleIds, setSelectedGameStyleIds] = useState<number[]>(initialGameStyleIds);
    ...
    return (
      <div className="h-full w-full">
        <div className="mb-4 flex items-center gap-3">
          <h2 className="bold-25 flex-1 border-b border-gray-200 pb-4">내 정보</h2>
        </div>
  ...
  return (
    <div className="h-full w-full">
      ...
      {/* Profile Card */}
      <div className="flex w-full gap-8 rounded-[30px] bg-gray-100 p-10" ref={containerRef}>
        {/* Avatar with edit */}
        ...
        <div className="flex flex-1 flex-col gap-7">
          ...
          <div className="flex items-center gap-4">
            ...
            <Switch checked={user?.mike === 'AVAILABLE'} onCheckedChange={handleToggleMike} />
          </div>
        </div>
      </div>
    </div>
