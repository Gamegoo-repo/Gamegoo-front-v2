        ...
        footer={
          <>
            <button
              ...
              className="flex w-full cursor-pointer items-center justify-center rounded-lg bg-violet-600 py-4 text-base leading-none font-bold text-white transition-all duration-300 hover:text-gray-300 active:scale-95"
            >
              나와 잘 맞는 유저를 찾고 싶다면?
            </button>
