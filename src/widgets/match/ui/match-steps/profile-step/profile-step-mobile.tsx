...
export default function ProfileStepMobile({ funnel, user }: ProfileStepMobileProps) {
  ...
  return (
    <>
      <MatchHeader
        ...
        funnel={funnel}
      />
      <div className="flex w-full items-center justify-center pt-0" ref={containerRef}>
