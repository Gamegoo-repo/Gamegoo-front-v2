...
function MatchStartStep({ funnel }: MatchStartStepProps) {
  ...
  return (
    <>
      <MatchHeader title="매칭 중" subtitle="나와 꼭 맞는 상대를 찾는 중..." onBack={handleBack} />
      <div className="flex w-full items-center justify-center">
        <div className="w-full max-w-[1440px]">
          <div className="mt-[0px] mb-[150px] flex w-full items-center justify-center gap-[59px] px-[10px] max-[1300px]:flex-col max-[1300px]:gap-[40px] mobile:mt-[70px] mobile:px-[0px]">
            <MatchStartProfile
              user={{
                ...authUser,
