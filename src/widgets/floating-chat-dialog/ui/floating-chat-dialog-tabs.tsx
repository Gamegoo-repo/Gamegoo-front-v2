import { CHAT_DIALOG_TABS, type ChatDialogType, useChatDialogStore } from '@/entities/chat';
...
function FloatingChatDialogTabs() {
  ...
  return (
    <div className="flex gap-[40px] border-b border-gray-200 px-[30px] shadow-[0_2px_5px_-2px_rgba(0,0,0,0.15)]">
      {TABS.map((tab) => (
        <button
          key={`chat-tab-${tab}`}
          name={tab}
          ...
          className={`bold-14 relative py-1 text-center font-medium text-gray-800 transition-colors after:absolute after:-bottom-[2px] after:left-1/2 after:h-[4px] after:-translate-x-1/2 after:rounded-[60px] after:bg-violet-600 after:content-[''] ${
